...
submitButton.addEventListener('click', () => {
    if (emailField.value === '') {
        ...
        let emailVerify = validateEmail(emailField.value);
        ...
        if (emailVerify) {
            ...
            popThanksMessage.innerHTML = `<div class="thanks-message-container">
                ...
                <p>A confirmation email has been sent to <b>${emailField.value}</b>. Please open it and click the button inside to confirm your subscription.</p>
